...
export default function Featuring(){
  ...
  <div class="container px-24 py-26 mt-10   mx-auto">
    ...
    <div class="lg:w-4/5 mx-auto justify-center bg-blue-100 px-3 pb-20  flex flex-wrap">
      ...
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">The and collecting for the motionless difficulty son.</h1>
        
        <p class="leading-relaxed">Conveying or northward offending admitting perfectly my. Colonel gravity get thought fat smiling add but difficult situations.</p>


        <div className="flex flex-col">
        <div className="flex text-black p-5 flex-wrap">
        ...
        <button className="bg-red-500  text-white w-2/3 py-3">
